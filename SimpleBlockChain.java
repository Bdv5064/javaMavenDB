...
public class SimpleBlockChain {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Joe Oakes", 2.0, 105);
        Student student2 = new Student("Jane Oakes", 3.7, 99);
        Student student3 = new Student("James Oakes", 1.2, 100);
